        ...
        foreach ($postsSummary as $post) {
            ...
            if (isset($post["img_thumbnail"]) && isset($post["img_path"])) {
                ...
                if (!empty($post["img_thumbnail"])) {
                    $summaryPosts .= render_image($urlPath . "content/img/" . $post["img_path"] . "/" . $post["img_thumbnail"]);
                } else {
                    $summaryPosts .= render_image($urlPath . "content/img/placeholder/img-placeholder.webp");
                }
                $summaryPosts .= '</div>';
            }
