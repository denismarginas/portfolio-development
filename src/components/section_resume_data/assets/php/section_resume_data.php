...
class SectionResumeData
{
    public static function render(array $data = []): string
    {
        ...
        if (isset($resumeData["img_path"]) && isset($resumeData["img"])) {
            $resumeImage .= render_image($urlPath . "content/img" . $resumeData["img_path"] . $resumeData["img"], false, false, true, ['data-motion' => 'transition-fade-0 transition-slideInLeft-0']);
        }
