...
class SectionExperienceKnowledge
{
    public static function render(array $data): string
    {
        ...
        if (isset($images["portrait"])) {
            ...
            $personImage .= render_image($GLOBALS['urlPath'] . "content/img" . $images["portrait"]["img_path"] . $images["portrait"]["img"]);
        ...
        if (isset($jsonDataExperience["text"])) {
            ...
            if (isset($images["banner"])) {
                ...
                $experienceContainer .= render_image($GLOBALS['urlPath'] . "content/img" . $images["banner"]["img_path"] . $images["banner"]["img"], true);
                $experienceContainer .= '</div>';
            }
            $experienceContainer .= '</div>';
        }
