...
class SectionPostItemsWeb
{
    public static function render(array $data = []): string
    {
        ...
        $deviceImgPath = $data['deviceLayoutImgPath'] ?? ($GLOBALS['urlPath'] . "src/content/img/" . "design-elements" . "/");
        $srcCurrent = __DIR__ . "/../../../../";
    ...
    protected static function render_web_item(array $postData, string $postPath, string $srcCurrent, string $urlPath, string $deviceLaptopImg, string $devicePhoneImg, string $deviceImgPath): string
    {
        ...
        if (isset($postData["post_type"]) && isset($postData["media_path"])) {
            $webPhoneImagePath = $urlPath . "src/content/img/" . $postData["post_type"] . "/" . $postData["media_path"] . "/web/phone/";
        ...
        if ($haveWebDesktopImage) {
            ...
            $webImagePathPreview = $urlPath . "src/content/img/" . $postData["post_type"] . "/" . $postData["media_path"] . "/web/home/";
