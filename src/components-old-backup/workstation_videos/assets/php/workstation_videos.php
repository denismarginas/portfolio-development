    ...
    public static function render(array $data = []): string
    {
        ...
        foreach ($postData['videos'] as $video) {
            ...
            $videoItems .= render_component('video', [
                'src' => $GLOBALS['urlPath'] . 'src/content/vid/' . $videoMediaPath . $video['video_path'],
                'thumbnail' => $GLOBALS['urlPath'] . 'src/content/img' . $video['video_thumbnail'],
                'thumbnail_bg' => $GLOBALS['urlPath'] . 'src/content/img/thumbnails/workpreview-overlay-thumbnail.webp',
