                ...
                foreach ($textList as $key => $item) {
                    if ($key == $middle) {
                        ...
                        if (!empty($imgPath) && !empty($imgLaptop)) {
                            $descriptionItems .= render_image($urlPath . "src/content/img/" . $imgPath . "/" . $imgLaptop, false, "dm-laptop-responsive");
                        }
                        if (!empty($imgPath) && !empty($imgTablet)) {
                            $descriptionItems .= render_image($urlPath . "src/content/img/" . $imgPath . "/" . $imgTablet, false, "dm-tablet-responsive");
                        }
                        if (!empty($imgPath) && !empty($imgPhone)) {
                            $descriptionItems .= render_image($urlPath . "src/content/img/" . $imgPath . "/" . $imgPhone, false, "dm-phone-responsive");
                        }
