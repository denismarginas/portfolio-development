        ...
        if (isset($jsonPortfolio) && !empty($jsonPortfolio)) {
            foreach ($jsonPortfolio as $video_item) {
                ...
                $portfolioItems .= renderVideo(
                    $GLOBALS['urlPath'] . 'src/content/vid/' . $video_item["video_path"] . $video_item["video"],
                    $GLOBALS['urlPath'] . "src/content/img" . $video_item["video_thumbnail_path"] . $video_item["video_thumbnail"]
                );
                $portfolioItems .= '</li>';
