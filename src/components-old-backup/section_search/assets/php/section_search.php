...
class SectionSearch
{
    public static function render(array $data = []): string
    {
        ...
        $indexDataUrl = $urlPath . 'src/content/json/index/index-data-post-pages.json';
        ...
        foreach ($indexPages as $item) {
            ...
            $searchItems .= '<img src="' . $urlPath . 'src/content/img/placeholder/page-placeholder.svg" lazy-load="true">';
